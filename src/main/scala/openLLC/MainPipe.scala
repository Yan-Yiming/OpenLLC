...
class MainPipe(implicit p: Parameters) extends LLCModule with HasCHIOpcodes {
  ...
  val AMOReqSrcID = RegInit(0.U(11.W))
  ...
  val atomicLoad_CLR_s3     = !refill_task_s3 && opcode_s3 === AtomicLoad_CLR // Look CLR
  ...
  val fstRound_s4 = task_s4.valid && atomics_s4 && !refill_task_s4
  ...
  val request_snoop_s4 = (exclusiveReq_s4 || invalidReq_s4 || atomics_s4) && peerRNs_hit_s4 || sharedReq_s4 && !self_hit_s4 ||
